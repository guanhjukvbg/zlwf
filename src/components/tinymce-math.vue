    ...
    mounted() {
      ...
      tinymce.init({
        ...
        toolbar: [
          ...
          'save preview  kityformula-editor subscript superscript  image table alignleft aligncenter alignright alignjustify link  outdent indent  emoticons hr bullist numlist blockquote removeformat',
        ],
        block_formats:
