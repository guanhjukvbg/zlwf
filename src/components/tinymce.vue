<template>
  <div>
    <form @submit.prevent="submitRichText">
  ...
  mounted() {
    tinymce.init({
      ...
      formats: {
        h1: {
          block: "h1",
          styles: { margin: "0px", padding: "0px", textAlign: "justify" },
        },
        h2: {
          block: "h2",
          styles: { margin: "0px", padding: "0px", textAlign: "justify" },
      ...
      fontsize_formats: "12px 14px 15px 16px 18px 24px 36px 48px 56px 72px",
      font_family_formats:
