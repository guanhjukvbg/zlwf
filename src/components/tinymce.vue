...
export default {
  mounted() {
    ...
    tinymce.init({
      ...
      toolbar: [
        'websearch summary abstract mindmap undo redo formatpainter forecolor backcolor bold italic underline strikethrough lineheight  blocks fontfamily fontsize customStyles',
