    ...
    mounted() {
      ...
      tinymce.init({
        ...
        toolbar: [
          ...
          '  preview image emoticons table bullist numlist alignleft aligncenter alignright alignjustify link  outdent indent   hr  blockquote subscript superscript  kityformula-editor  removeformat ',
        ],
        block_formats:
