<template>
    <div>
      <textarea id="tinymce-math"></textarea>
    </div>
  </template>
  ...
  export default {
    mounted() {
      ...
      tinymce.init({
        ...
        language: "zh_CN",
        placeholder:'请在此输入内容',
        plugins: 'websearch_plugin summary_plugin abstract_plugin mindmap_plugin save quickbars formatpainter paste preview searchreplace autolink directionality visualblocks visualchars fullscreen image link  codesample table charmap kityformula-editor hr pagebreak nonbreaking anchor insertdatetime advlist lists wordcount textpattern help emoticons autosave',
        quickbars_insert_toolbar: 'kityformula-editor  quickimage quicktable',
        ...
        toolbar: [
          ...
          'save preview  kityformula-editor subscript superscript  image table alignleft aligncenter alignright alignjustify link  outdent indent  emoticons hr bullist numlist blockquote summary abstract mindmap removeformat',
        ],
        block_formats:
