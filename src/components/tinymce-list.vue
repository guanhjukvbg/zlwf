<template>
    <div>
      <textarea id="tinymce-list"></textarea>
    </div>
  </template>
    ...
    mounted() {
      ...
      tinymce.init({
        ...
        toolbar: [
          ...
          'websearch save preview  bullist numlist image table  emoticons alignleft aligncenter alignright alignjustify link  outdent indent  hr blockquote  summary abstract mindmap  removeformat',
        ],
        block_formats:
